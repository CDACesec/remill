...
class Instruction {
 public:
  ...
  enum Category {
    ...
    kCategoryError,                               // 2 
    kCategoryNoOp,                                // 3
    kCategoryDirectJump,                          // 4 
    kCategoryUnconditionalBranch,                 // 9                         
    kCategoryIndirectJump,                        // 5
    kCategoryDirectFunctionCall,                  // 6
    kCategoryIndirectFunctionCall,                // 7    
    kCategoryFunctionReturn,                      // 8
    kCategoryPipelineBranch,                      // 10                        
    kCategoryConditionalBranch,                   // 11
    kCategoryAsyncHyperCall,                      // 12 
    kCategoryConditionalAsyncHyperCall,           // 13 
    kCategoryConditionalCall, 
  } category;
  ...
  inline bool IsDirectControlFlow(void) const {
    switch (category) {
      ...
      case kCategoryUnconditionalBranch:                                     
        return true;
      default:
        return false;
    }
  ...
  inline bool IsPipelineBranch(void) const {                                
    return kCategoryPipelineBranch == category;
  }                                                                           
