...
typedef Rn<float32_t>FP32;        /* read a floating point reg */
typedef RnW<float32_t>FP32W;      /* write to a floating point reg*/
typedef Rn<float64_t>FP64;        /* read a double precision floating point reg */
typedef RnW<float64_t>FP64W;      /* write to a double precision floating point reg*/
...
typedef MnW<float32_t> FPM32W;     /* write a float to mem */
typedef MnW<float64_t> FPM64W;     /* write a double to mem */
