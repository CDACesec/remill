...
#ifndef REMILL_BUILD_SEMANTICS_DIR_MIPSEL
#error "Macro `REMILL_BUILD_SEMANTICS_DIR_MIPSEL` must be defined to support Mips32 architecture."
#define REMILL_BUILD_SEMANTICS_DIR_MIPSEL
#endif  // REMILL_BUILD_SEMANTICS_DIR_MIPSEL
...
static const char *gSemanticsSearchPaths[10] = {                     // replace 6 with 10
    // Derived from the build.
    REMILL_BUILD_SEMANTICS_DIR_X86 "\0",
    REMILL_BUILD_SEMANTICS_DIR_AARCH64 "\0",
    REMILL_BUILD_SEMANTICS_DIR_MIPSEL "\0",                           // added
